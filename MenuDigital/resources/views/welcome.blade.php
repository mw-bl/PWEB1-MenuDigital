...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            @if (isset($cardapios) && $cardapios->isNotEmpty())
                @foreach ($cardapios as $cardapio)
                    <div class="col-md-4">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalCardapio{{ $cardapio->id_cardapio }}">
                                    Ver Itens
                                </button>
                            </div>
                        </div>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="modalCardapio{{ $cardapio->id_cardapio }}" tabindex="-1" aria-labelledby="modalLabel{{ $cardapio->id_cardapio }}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalLabel{{ $cardapio->id_cardapio }}">Cardápio: {{ $cardapio->descricao }}</h5>
                ...
                @endforeach
            @else
                <p>Não há cardápios disponíveis no momento.</p>
            @endif
        </div>
    </div>
@endsection
